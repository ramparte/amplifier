...
# from amplifier.valid import function_name, ClassName


class TestValid:
    """Test class for valid module."""

    def test_basic_functionality(self):
        """Test basic functionality of valid."""
